...
def main():
    ...
    srv_client_generate_random_point_=rospy.ServiceProxy('generate_random_point', GeneratePoint)
    ...
    while not rospy.is_shutdown():
        if state_ ==2:
            ...
            if ui_ == 6:
                ...
                rospy.set_param('des_pos_x', resp.x)
                rospy.set_param('des_pos_y', resp.y)
