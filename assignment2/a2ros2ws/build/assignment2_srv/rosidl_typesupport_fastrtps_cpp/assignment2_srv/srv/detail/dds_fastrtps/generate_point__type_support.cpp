...
#include "assignment2_srv/srv/detail/generate_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const assignment2_srv::srv::GeneratePoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<assignment2_srv::srv::GeneratePoint_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GeneratePoint_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const assignment2_srv::srv::GeneratePoint_Request *>(
...
{
  return max_serialized_size_GeneratePoint_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _GeneratePoint_Request__callbacks = {
  "assignment2_srv::srv",
...
static rosidl_message_type_support_t _GeneratePoint_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GeneratePoint_Request__callbacks,
...
{
  return &assignment2_srv::srv::typesupport_fastrtps_cpp::_GeneratePoint_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const assignment2_srv::srv::GeneratePoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<assignment2_srv::srv::GeneratePoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GeneratePoint_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const assignment2_srv::srv::GeneratePoint_Response *>(
...
{
  return max_serialized_size_GeneratePoint_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _GeneratePoint_Response__callbacks = {
  "assignment2_srv::srv",
...
static rosidl_message_type_support_t _GeneratePoint_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GeneratePoint_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &assignment2_srv::srv::typesupport_fastrtps_cpp::_GeneratePoint_Response__handle;
}
...
static service_type_support_callbacks_t _GeneratePoint__callbacks = {
  "assignment2_srv::srv",
  "GeneratePoint",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_srv, srv, GeneratePoint_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_srv, srv, GeneratePoint_Response)(),
...
static rosidl_service_type_support_t _GeneratePoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GeneratePoint__callbacks,
...
{
  return &assignment2_srv::srv::typesupport_fastrtps_cpp::_GeneratePoint__handle;
}
