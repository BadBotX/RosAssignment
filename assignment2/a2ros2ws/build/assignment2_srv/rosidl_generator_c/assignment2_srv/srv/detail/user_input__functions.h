...
#ifndef ASSIGNMENT2_SRV__SRV__DETAIL__USER_INPUT__FUNCTIONS_H_
#define ASSIGNMENT2_SRV__SRV__DETAIL__USER_INPUT__FUNCTIONS_H_
...
/// Initialize srv/UserInput message.
/**
...
/// Finalize srv/UserInput message.
/**
...
/// Create srv/UserInput message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * assignment2_srv__srv__UserInput_Request__init().
...
/// Destroy srv/UserInput message.
/**
 * It calls
 * assignment2_srv__srv__UserInput_Request__fini()
...
/// Initialize array of srv/UserInput messages.
/**
...
/// Finalize array of srv/UserInput messages.
/**
 * It calls
 * assignment2_srv__srv__UserInput_Request__fini()
...
/// Create array of srv/UserInput messages.
/**
 * It allocates the memory for the array and calls
 * assignment2_srv__srv__UserInput_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/UserInput messages.
/**
 * It calls
 * assignment2_srv__srv__UserInput_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * assignment2_srv__srv__UserInput_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment2_srv
...
/**
 * It calls
 * assignment2_srv__srv__UserInput_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment2_srv
...
/**
 * It allocates the memory for the array and calls
 * assignment2_srv__srv__UserInput_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment2_srv
...
/**
 * It calls
 * assignment2_srv__srv__UserInput_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ASSIGNMENT2_SRV__SRV__DETAIL__USER_INPUT__FUNCTIONS_H_
