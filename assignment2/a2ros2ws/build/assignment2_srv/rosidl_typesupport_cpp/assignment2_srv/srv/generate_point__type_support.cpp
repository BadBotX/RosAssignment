...
static const _GeneratePoint_Request_type_support_symbol_names_t _GeneratePoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_srv, srv, GeneratePoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment2_srv, srv, GeneratePoint_Request)),
  }
};
...
{
  return &::assignment2_srv::srv::rosidl_typesupport_cpp::GeneratePoint_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assignment2_srv, srv, GeneratePoint_Request)() {
  return get_message_type_support_handle<assignment2_srv::srv::GeneratePoint_Request>();
}
...
static const _GeneratePoint_Response_type_support_symbol_names_t _GeneratePoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_srv, srv, GeneratePoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment2_srv, srv, GeneratePoint_Response)),
  }
};
...
{
  return &::assignment2_srv::srv::rosidl_typesupport_cpp::GeneratePoint_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assignment2_srv, srv, GeneratePoint_Response)() {
  return get_message_type_support_handle<assignment2_srv::srv::GeneratePoint_Response>();
}
...
static const _GeneratePoint_type_support_symbol_names_t _GeneratePoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_srv, srv, GeneratePoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment2_srv, srv, GeneratePoint)),
  }
};
...
{
  return &::assignment2_srv::srv::rosidl_typesupport_cpp::GeneratePoint_service_type_support_handle;
}
